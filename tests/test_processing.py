...
def test_filter_by_state_expected_data(input: list[dict], output: list[dict]) -> None:
...
def test_filter_by_state_with_state_data(input: list[dict], state: str, output: list[dict]) -> None:
...
def test_sort_by_date_no_sort_order_data(input: list[dict], output: list[dict]) -> None:
...
def test_sort_by_date_same_date(input: list[dict], output: list[dict]) -> None:
    assert sort_by_date(input) == output
...
def test_sort_by_date_expected_data(input: list[dict], reverse: bool, output: list[dict]) -> None:
...
def test_sort_by_date_different_date_format(input: list[dict], output: list[dict]) -> None:
    assert sort_by_date(input) == output
...
def test_sort_by_date_wrong_date_format(input: list[dict]) -> None:
